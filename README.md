...
This repository is the client (front-end) for my Campus Management project submission.

Group Members: Just me (Ataur Muhith)

----------
### To set up and run the client (front-end) application on your local machine:
